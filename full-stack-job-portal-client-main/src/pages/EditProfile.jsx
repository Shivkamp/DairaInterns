...
const EditProfile = () => {
    ...
    const onSubmit = async (data) => {
        const { username, resume, gender } = data;
                        ...
                        <div className="profile-form">
                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    name="school"
                                    placeholder="Type Here"
                                    defaultValue={user?.school} // preset the value to user.school
                                    readOnly
                                />
                                {/* You might want to rename id and name attributes to "school" instead of "location" */}
                                {errors?.school && (
                                    <span className="text-[10px] font-semibold text-red-600 mt-1 pl-1 tracking-wider">
