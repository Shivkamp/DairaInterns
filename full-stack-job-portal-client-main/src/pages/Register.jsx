...
const Register = () => {
    ...
    const onSubmit = async (data) => {
        // password: A@1abcde
        const { username, name, school, email, password, confirmPassword } = data;
        ...
        if (password !== confirmPassword) {
            ...
            setIsLoading(true);
            const user = { username, name, school, email, password };
            // posting
            try {
                    ...
                    <div className="row">
                        ...
                        <input
                            ...
                            {...register("name", {
                                ...
                                maxLength: {
                                    value: 30,
                                    message: "Name is too long(max 30char)",
                                },
                                minLength: {
                                    value: 3,
                                    message:
                                        "Name is too short (min 3char)",
                                },
                                // pattern: {
                                //     value: /^[A-Za-z][A-Za-z0-9_]*$/,
                                //     message:
                                //         "Name can't start with number and special characters",
                                // },
                            })}
                        />
                        {errors?.name && (
                    ...
                    <div className="row">
                        ...
                        <input
                            ...
                            {...register("school", {
                                ...
                                maxLength: {
                                    value: 30,
                                    message: "School is too long(max 30char)",
                                },
                                minLength: {
                                    value: 3,
                                    message:
                                        "School is too short (min 3char)",
                                },
                                // pattern: {
                                //     value: /^[A-Za-z][A-Za-z0-9_]*$/,
                                //     message:
